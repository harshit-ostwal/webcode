...
function TableHead({ className, ...props }) {
  return (
    <th
      ...
      className={cn(
        "h-14 px-10 text-start align-middle font-semibold whitespace-nowrap text-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[4px]",
        className,
      )}
      {...props}
    />
...
function TableCell({ className, ...props }) {
  return (
    <td
      ...
      className={cn(
        "p-3 px-10 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[4px]",
        className,
      )}
      {...props}
    />
